...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $identifier = trim($_POST['email'] ?? $_POST['student_id'] ?? $_POST['identifier'] ?? '');
    ...
    if (empty($error)) {
        $stmt = $pdo->prepare("SELECT * FROM users WHERE (email = ? OR student_id = ?) AND role IN ('admin', 'superadmin') LIMIT 1");
...
<head>
  ...
  <title>Admin Portal Sign In | ALERTO - CSU-Carig Student Council</title>
          ...
          <div class="login-portal-card">
            ...
            <div class="portal-card-header">
              ...
              <div class="portal-title-block">
                <h2>Admin Portal</h2>
                <p>For administrators and authorized personnel only.</p>
              </div>
            </div>

            <!-- PHP Error Message -->
            <?php if (!empty($error)): ?>
            <div class="portal-error-message" role="alert" style="
              margin: 0 0 16px 0;
              padding: 12px 16px;
            ...
            <!-- Sign In Form -->
            <form class="login-form-body" id="adminLoginForm" method="POST" action="admin-login.php">
              ...
              <div class="input-group">
                ...
                <div class="input-container">
                  ...
                  <input type="text" id="adminUserEmail" name="email" class="portal-text-input"
              ...
              <div class="input-group">
                ...
                <div class="input-container">
                  ...
                  <input type="password" id="adminUserPassword" name="password" class="portal-text-input has-eye"
                    placeholder="Enter your password" required autocomplete="current-password">
                  <button type="button" class="password-eye-toggle-btn" aria-label="Show password" onclick="togglePasswordEye(this, 'adminUserPassword')">
              ...
              <div class="login-options-row" style="justify-content: flex-end;">
                <a href="javascript:void(0)"
                  onclick="alert('Please contact a superadmin to reset your password.')"
                  class="forgot-link">Forgot password?</a>
              </div>

              <!-- Submit Button -->
              <button type="submit" class="portal-submit-btn" id="loginSubmitBtn">
                Log in
              </button>
              ...
              <div class="portal-restricted-box">
                ...
                <span class="restricted-text">
                  This portal is restricted to authorized CSU-COEA Student Council personnel.
                </span>
              </div>
              ...
              <div class="login-card-footer-stack">
                <div class="role-switch-centered">
                  <a href="user-login.php" class="role-switch-pill student-pill">
                    ...
                    <span>Login as Student &rarr;</span>
                  </a>
                </div>
              </div>
